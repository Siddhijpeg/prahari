...
// Same figures shown elsewhere on this screen (91% confidence, ₹4.8L, 46–110 min window)
// fed through the same formula used in Alert Center, so the number is consistent everywhere.
const caseInterventionValue = interventionValue({ confidence: 91, amount: '₹4.8L', window: '46–110 minutes' });
            ...
            <div className="p-5 bg-gradient-to-br from-[#7C5CFC]/5 to-[#4338CA]/3">
              <div className="flex items-start justify-between mb-4">
                ...
                <div className="text-right">
                  ...
                  <div className="text-xs font-semibold text-[#7C5CFC] mt-2">Est. Recoverable</div>
                  <div className="font-mono text-sm font-bold text-[#0F172A]">{formatCompactINR(caseInterventionValue)}</div>
                </div>
              </div>
